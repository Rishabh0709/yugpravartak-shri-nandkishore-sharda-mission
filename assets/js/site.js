...
/* ==========================================================
   ...
   Header/footer are rendered at build time (Eleventy), so this
   runs directly on DOMContentLoaded — no component fetch.
   (Replaces the old assets/js/components.js runtime loader.)
========================================================== */
...
function initializeNavigation() {
    ...
    window
        ...
        .addEventListener("change", closeSubmenus);
}
